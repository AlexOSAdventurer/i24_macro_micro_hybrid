...
class I24SimulationData:
    ...
    def create_network_file(self):
        ...
        triangular_fd = simulation.TriangularFD(v_f=44.94205402836698, w=5.674885198817296, rho_j=0.11057508095357337)
        self.network_generator = simulation.I24WestAndEastNetwork(fd=triangular_fd, lambda_lc=0.14749564425588177)
