...
class I24SimulationData:
    ...
    def create_network_file(self):
        ...
        triangular_fd = simulation.TriangularFD(v_f=40.0, w=5.24, rho_j=0.10)
        self.network_generator = simulation.I24WestAndEastNetwork(fd=triangular_fd, lambda_lc=0.24044842275694597)
